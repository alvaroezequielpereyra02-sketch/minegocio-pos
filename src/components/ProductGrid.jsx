...
const ProductGrid = memo(function ProductGrid({
    ...
    const activeSubCategories = useMemo(() => {
        ...
        // Si seleccioné un padre, mostrar sus hijos. Si seleccioné un hijo, mostrar sus hermanos.
    ...
    return (
        <div className="flex-1 flex flex-col min-h-0">
            ...
            {/* BARRA DE SUBCATEGORÍAS (Se muestra solo si hay desglose) */}
            {activeSubCategories.length > 0 && (
                <div className="flex gap-2 overflow-x-auto pb-2 mb-2 scrollbar-hide shrink-0 px-1 animate-in slide-in-from-top-2 fade-in">
                    {/* Botón para "Todo de esta categoría" */}
                    <button
                        onClick={() => {
