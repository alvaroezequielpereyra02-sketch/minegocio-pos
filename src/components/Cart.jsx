        ...
        <div className="bg-white h-full flex flex-col">
            ...
            <div className="p-4 bg-slate-50 border-t space-y-4 z-10 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                ...
                <div className="space-y-3">
                    ...
                    <button onClick={handleCheckout} disabled={cart.length === 0} className={`w-full py-3.5 rounded-lg font-bold text-lg shadow-lg transition-all transform active:scale-[0.98] ${cart.length > 0 ? 'bg-blue-600 text-white hover:bg-blue-700 hover:shadow-blue-200' : 'bg-slate-300 text-slate-500 cursor-not-allowed'}`}>
                        Cobrar
                    </button>
                </div>
            </div>
