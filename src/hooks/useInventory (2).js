...
export const useInventory = (user, userData) => {
    ...
    const deleteProduct = async (id) => updateDoc(doc(db, 'stores', appId, 'products', id), {
        isActive:  false,
    ...
    const generateInvitationCode = async () => {
        // crypto.getRandomValues es criptográficamente seguro (a diferencia de Math.random,
        // que con ~2.7M combinaciones posibles era vulnerable a fuerza bruta).
