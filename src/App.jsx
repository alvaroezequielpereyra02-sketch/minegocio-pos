...
// Importamos html2pdf directamente para evitar errores de resolución dinámica
...
export default function App() {
  ...
  const handleCheckout = async () => {
    ...
    const saleData = {
      type: 'sale',
      total: cartTotal,
      amountPaid: 0, // Pendiente por defecto
      items: itemsWithCost,
  ...
  const handleShareWhatsApp = async (transaction) => {
    ...
    try {
      ...
      // html2pdf ya está importado arriba
      const opt = {
        margin: [0, 0, 0, 0],
