/**
 * lib/firebase.js — Inicialización compartida de Firebase Admin + utilidades FCM
 *
 * Movido desde api/_firebase.js (Fase 2A — consolidación de funciones).
 * Sin cambios de lógica, solo de ubicación: los archivos dentro de api/
 * cuentan para el límite de funciones serverless de Vercel, aunque
 * empiecen con guion bajo — por eso todos los helpers se sacan de ahí.
 *
